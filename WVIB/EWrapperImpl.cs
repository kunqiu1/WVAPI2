...
namespace WVIB
{
    ...
    public class EWrapperImpl : EWrapper
    {
        ...
        public event EventHandler<ManagedAccountsArg> OnManagedAccounts;
        public virtual void managedAccounts(string accountsList)
        {
            OnManagedAccounts?.Invoke(this, new ManagedAccountsArg(accountsList));
        }


        public event EventHandler<UpdatePortfolioArg> OnUpdatePortfolio;
        ...
        {
            OnUpdatePortfolio?.Invoke(this, new UpdatePortfolioArg(contract, position, marketPrice, marketValue, averageCost, unrealizedPNL, realizedPNL, accountName));
        }

        public event EventHandler<UpdateAccountArg> OnUpdateAccount;
        public virtual void updateAccountValue(string key, string value, string currency, string accountName)
        {
            OnUpdateAccount?.Invoke(this, new UpdateAccountArg(key, value, currency, accountName));
        }

        public event EventHandler<TickPriceArg> OnManagedTickPrice;
        public virtual void tickPrice(int tickerId, int field, double price, TickAttrib attribs)
        {
            OnManagedTickPrice?.Invoke(this, new TickPriceArg(tickerId, field, price, attribs));
        }

        public event EventHandler<ErrorMessageArg> OnError1;
        public virtual void error(int id, int errorCode, string errorMsg)
        {
            OnError1?.Invoke(this, new ErrorMessageArg(id, errorCode, errorMsg));
        }

        public event EventHandler<TickOptionComputationArg> OntickOptionComputation;
